...
<div class=" my-4" style="margin: auto;">
 ...
 $result = mysqli_query($conn,"Select * from planner");
...
<div class="card text-center my-4" style=" max-width: 720px; margin: auto;">
  ...
  <h3> Event Planner Information Update</h3>
  </div>
  <div class="container">
...
<form  method="post" class="form-inline" role="form" style="font-size: 2rem;text-align: center;" >
  ...
  <div class="card-footer text-muted">
	...
	{
		$vid=$_SESSION["id"];
		$sql="UPDATE photographer Set `pl_id`='$_POST[id]',`pl_name`='$_POST[name]',`email`='$_POST[em]',`address`='$_POST[ad]',`phone_no`='$_POST[pn]',`bank_info`='$_POST[bi]',`cost`='$_POST[co]',`package`='$_POST[cpc]',`date`='$_POST[dt]',`time`='$_POST[tm]',`booked`='$_POST[dt]' Where `pl_id`='$vid'";
		...
		if($data)
		{
           // $_SESSION["user"][0]["user_name"]=$_POST["name"];
			echo "Updated";
			echo '<script>window.location="pl_up.php"</script>';  
		}
    ...
    ?>
      ...
      <div class="modal-footer">
       ...
       if( isset($_POST["sub"])){
        	echo "hh";
  $dplid=$_SESSION["id"];
$query = "DELETE FROM `planner` WHERE `pl_id`='$dplid'"; 
$result = mysqli_query($conn,$query) or die ( mysqli_error());

			//echo "Deleted";
			echo '<script>location="pl_up.php"</script>';
...
<form  method="post" class="form-inline" role="form" style="font-size: 2rem;text-align: center;" >
  ...
  <div class="card-footer text-muted">
	...
	{
		$vid=$_SESSION["id"];
		$sql="INSERT INTO `planner` Set `pl_id`='$_POST[iid]',`pl_name`='$_POST[name]',`email`='$_POST[em]',`address`='$_POST[ad]',`phone_no`='$_POST[pn]',`bank_info`='$_POST[bi]',`cost`='$_POST[co]',`package`='$_POST[cpc]',`date`='$_POST[dt]',`time`='$_POST[tm]',`booked`='$_POST[dt]'";
		$data=mysqli_query($conn,$sql);
