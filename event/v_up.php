 ...
 <!DOCTYPE html>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
        ...
        <?php
            ...
            <div class="container my-4" style="margin: auto;">
 ...
 // $_SESSION["test1"]= $row;
		...
		//  echo mysqli_num_rows($result);
			while ( $row = mysqli_fetch_array($result)) {
				//$c=$c+1;
			//$_SESSION["test"]= mysqli_fetch_array($result);
			//print_r($_SESSION["test"]);
				...
				?><tr class="border-bottom" style="font-size: 1rem;">
                	<td><?php echo $row["v_id"];$_SESSION["id"]=$id; ?></td>
...
<div class="card text-center my-4" style=" max-width: 720px; margin: auto;">
  ...
  <h3> Venue Information Update</h3>
  </div>
  <div class="container">
...
<form  method="post" class="form-inline" role="form" style="font-size: 2rem;text-align: center;" >
	...
	<div class="form-group m-2">
		<label class="control-label mr-2" for="ps"><h3>Capacity</h3></label>
	    <input class="form-control " type="number" name="cpc" class="textInput">
	</div>
	<div class="form-group m-2">
  ...
  <div class="card-footer text-muted">
	...
	{
		$vid=$_SESSION["id"];
		$sql="UPDATE venue Set `v_id`='$_POST[id]',`v_name`='$_POST[name]',`email`='$_POST[em]',`address`='$_POST[ad]',`phone_no`='$_POST[pn]',`bank_info`='$_POST[bi]',`cost`='$_POST[co]',`capacity`='$_POST[cpc]',`date`='$_POST[dt]',`vtime`='$_POST[tm]',`booked`='$_POST[dt]' Where `v_id`='$vid'";
		...
		if($data)
		{
           // $_SESSION["user"][0]["user_name"]=$_POST["name"];
			echo "Updated";
			echo '<script>window.location="v_up.php"</script>';  
		}
    ...
    ?>
      ...
      <div class="modal-footer">
       ...
       if( isset($_POST["sub"])){
        	echo "hh";
  $dvid=$_SESSION["id"];
$query = "DELETE FROM `venue` WHERE `v_id`='$dvid'"; 
$result = mysqli_query($conn,$query);

			//echo "Deleted";
			echo '<script>location="v_up.php"</script>';
...
<div class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="insertModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="insertModalLabel">Insert a new Venue</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<form  method="post" class="form-inline" role="form" style="font-size: 2rem;text-align: center;" >
  ...
  <div class="card-footer text-muted">
	...
	{
		$vid=$_SESSION["id"];
		$sql="INSERT INTO `venue` Set `v_id`='$_POST[iid]',`v_name`='$_POST[name]',`email`='$_POST[em]',`address`='$_POST[ad]',`phone_no`='$_POST[pn]',`bank_info`='$_POST[bi]',`cost`='$_POST[co]',`capacity`='$_POST[cpc]',`date`='$_POST[dt]',`vtime`='$_POST[tm]',`booked`='$_POST[dt]'";
		$data=mysqli_query($conn,$sql);
