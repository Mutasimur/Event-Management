...
<div class="card text-center my-4" style=" max-width: 720px; margin: auto;font-family: perpetua bold;">
...
<form  method="post" class="form-inline" role="form" style="font-size: 2rem;text-align: center;" >
  ...
  <div class="card-footer text-muted">
	...
	{
		$sql="UPDATE `user` Set `name`='$_POST[name]',`email`='$_POST[em]',`address`='$_POST[ad]',`phone_no`='$_POST[pn]',`bank_info`='$_POST[bi]',`password`='$_POST[ps]' Where `user_id`='$u_id'";
