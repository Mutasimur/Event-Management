 ...
 <!DOCTYPE html>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
        ...
        <body style="background: #f6f6fd; font-family: Perpetua Bold;color:#093B04; ">
          <header class="site-header sticky-top" style="font-family: Perpatua Bold;">
          <div class="navbar-light align-items-center shadow-sm " style="background:#d0fbcc;">
           ...
           <form  method="post" action="searchph.php">
...
$sqld="SELECT * FROM `photographer` WHERE `uid` = '$did' ";
    ...
    if(mysqli_num_rows($resultd) > 0)  
                {  
                  ...
                  ?><div class="container my-3" style="align-items: center;"><?php
                     ...
                     {  ?>
                      <form method="post" action="showDetailp.php" 
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                      ...
                      else if(isset($_SESSION["book_cart_ph"])){
                        ?>
 ...
 <div class="modal fade" id="exModal" tabindex="-1" role="dialog" aria-labelledby="exModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4>You have already booked a Photographer</h4>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-success" data-dismiss="modal">Close</button>
                       ...
                       else if($_SESSION["book"]  || ($_SESSION["user"][0]["user_phb"])){
                        //echo $_SESSION["book"];
                        ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h6>You can only book 1 photographer</h6>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-success" data-dismiss="modal">Close</button>
